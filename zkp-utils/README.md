...
_This is a work in progress - We recommend that you only use it for experimentation. We cannot help
you to get it up and running yet_
...
This version implements commitments using El-Gamal encryption (replacing SHA in the main Nightfall
repo), so that the hiding may be reversed with the correct keys. This may be required for regulatory
compliance.

Irrespective of the above, we hope you find the El-Gamal implementation on the BabyJubJub curve
interesting.
